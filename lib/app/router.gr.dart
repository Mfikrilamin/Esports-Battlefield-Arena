...
import 'package:esports_battlefield_arena/models/tournament.dart' as _i21;
...
abstract class $AppRouter extends _i18.RootStackRouter {
  ...
  final Map<String, _i18.PageFactory> pagesMap = {
    ...
    OrganizedTournamentDetailRoute.name: (routeData) {
      ...
      return _i18.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i17.OrganizedTournamentDetailView(
          key: args.key,
          tournament: args.tournament,
        ),
      );
...
class CreateTournamentRoute extends _i18.PageRouteInfo<void> {
  const CreateTournamentRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class MyOrganizedTournamentRoute extends _i18.PageRouteInfo<void> {
  const MyOrganizedTournamentRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class NicknameVerificationRoute
    extends _i18.PageRouteInfo<NicknameVerificationRouteArgs> {
  ...
  static const _i18.PageInfo<NicknameVerificationRouteArgs> page =
      _i18.PageInfo<NicknameVerificationRouteArgs>(name);
}
...
class ParticipantInformationRoute extends _i18.PageRouteInfo<void> {
  const ParticipantInformationRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class PaymentHistoryRoute extends _i18.PageRouteInfo<void> {
  const PaymentHistoryRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class PlayerRegisteredTournamentRoute extends _i18.PageRouteInfo<void> {
  const PlayerRegisteredTournamentRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class TournamentRegistrationRoute
    extends _i18.PageRouteInfo<TournamentRegistrationRouteArgs> {
  TournamentRegistrationRoute({
    _i19.Key? key,
    required _i21.Tournament tournament,
    List<_i18.PageRouteInfo>? children,
  }) : super(
  ...
  static const _i18.PageInfo<TournamentRegistrationRouteArgs> page =
      _i18.PageInfo<TournamentRegistrationRouteArgs>(name);
}
...
class TournamentRegistrationRouteArgs {
  ...
  final _i21.Tournament tournament;
...
/// generated route for
/// [_i13.SignUpNextView]
class SignUpNextRoute extends _i18.PageRouteInfo<void> {
  const SignUpNextRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
class TestingRoute extends _i18.PageRouteInfo<void> {
  const TestingRoute({List<_i18.PageRouteInfo>? children})
      : super(
          TestingRoute.name,
          initialChildren: children,
        );
...
class TournamentDetailRoute
    extends _i18.PageRouteInfo<TournamentDetailRouteArgs> {
  ...
  static const _i18.PageInfo<TournamentDetailRouteArgs> page =
      _i18.PageInfo<TournamentDetailRouteArgs>(name);
}
...
class LeaderboardRoute extends _i18.PageRouteInfo<void> {
  const LeaderboardRoute({List<_i18.PageRouteInfo>? children})
      : super(
...
/// generated route for
/// [_i17.OrganizedTournamentDetailView]
class OrganizedTournamentDetailRoute
    extends _i18.PageRouteInfo<OrganizedTournamentDetailRouteArgs> {
  ...
  static const _i18.PageInfo<OrganizedTournamentDetailRouteArgs> page =
      _i18.PageInfo<OrganizedTournamentDetailRouteArgs>(name);
}
