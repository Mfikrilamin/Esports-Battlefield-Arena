...
class LoaderLeading extends StatefulWidget {
  const LoaderLeading({Key? key}) : super(key: key);

  @override
  _LoaderState createState() => _LoaderState();
}

class _LoaderState extends State<LoaderLeading>
...
class LoaderCanvas extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(center, size.width / 2, circle);
    canvas.drawArc(
        Rect.fromCenter(
            center: center,
